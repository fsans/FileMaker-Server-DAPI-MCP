...
The same configuration works for other MCP-compatible AI assistants. Refer to your specific client's documentation for the MCP configuration file location and specific file locations.
